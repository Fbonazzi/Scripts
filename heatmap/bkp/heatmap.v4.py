...
immagine=Image.new("RGBA",(100*width,100*height),(255,255,255,0))
...
for i in xrange(0,height):		
	for j in xrange(0,width):
		temp=matrice[i][j]-20
#		print temp
		matrice[i][j]=math.floor((temp/80)*255)
#		print matrice[i][j]
		ind=int(matrice[i][j])
#		print ind
		r = scheme_classic[ind][0]
		g = scheme_classic[ind][1]
		b = scheme_classic[ind][2]

#		print r,g,b

		for k in xrange(0,100):
			for l in xrange(0,100):
				pixel[100*j+l, 100*i+k]=(r,g,b,128)	#i e j scambiate?? WTF
